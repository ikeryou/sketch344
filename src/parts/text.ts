...
export class Text extends MyObject3D {
    ...
    this._mesh = new Mesh(
      ...
      new ShaderMaterial({
        ...
        uniforms:{
          ...
          line:{value:Util.instance.map(this._noise.x, 1, 0, 0, Conf.instance.TEXT_NUM - 1)},
          time:{value:0},
        }
      })
    )
  ...
  protected _update():void {
    ...
    this.position.z = Util.instance.map(this._noise.x, 0, -1, 0, Conf.instance.TEXT_NUM - 1) * s;
